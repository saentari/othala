...
import 'lnurl_confirmation_view_model.dart';

class LnUrlConfirmationView extends StatelessWidget {
  const LnUrlConfirmationView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<LnUrlConfirmationViewModel>.reactive(
      viewModelBuilder: () => LnUrlConfirmationViewModel(),
