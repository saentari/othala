...
import 'wallet_derivation_view_model.dart';

class WalletDerivationView extends StatelessWidget {
  const WalletDerivationView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<WalletDerivationViewModel>.reactive(
      viewModelBuilder: () => WalletDerivationViewModel(),
